"""
Django settings for skincareclinc project.
...
ROOT_URLCONF = 'skincareclinc.urls'
...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'context_processors': [
                ...
                'apps.store.context_processors.brand_categories',
...
WSGI_APPLICATION = 'skincareclinc.wsgi.application'
